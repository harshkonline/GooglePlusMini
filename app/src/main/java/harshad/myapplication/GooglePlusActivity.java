...
public class GooglePlusActivity extends ActionBarActivity implements ActionBar.TabListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        circle_list = activity.getStringArrayExtra("circle_view");
        circle_children_list = FetchInformation.getArray();
        circle_children_people = FetchInformation.getCircle_children_people();
    ...
    public static class MyProfile extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.information_fetch, container, false);
    ...
    public static class MyCircles extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, final ViewGroup container,
            ...
            list.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
                ...
                public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
                    ...
                    Intent activity = new Intent(parent.getContext(), FriendsProfileInformation.class);
                    activity.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        ...
        public class FriendListAdapter extends BaseExpandableListAdapter {
            ...
            public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
                if (convertView == null) {
                    convertView = inflater.inflate(R.layout.circle_view, null);
                }
            ...
            public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
                if (convertView == null) {
                    convertView = inflater.inflate(R.layout.point, null);
                }
